...
export default function Carpark(props) {
  ...
  const distanceBetween = getDistanceFromLatLonInM(destinationLatitude,destinationLongitude,carparkLatitude,carparkLongitude); 
  return (
    <View style={styles.container}>
      <View style={styles.markerContainer}>
        <Image style={styles.marker} source={require('../images/marker.png')} />
        <Text style={styles.distance}>{Math.round(distanceBetween) + "m"}</Text>
      </View>
